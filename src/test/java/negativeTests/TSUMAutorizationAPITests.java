...
public class TSUMAutorizationAPITests {
	...
	public static final String BASE_HOST = "https://api.tsum.ru";
	...
	public static String PATH_SIGN_IN = "sign-in";
	...
	public void createAPISoureces(){
		...
		stepsRestHttpMethods.gettingAPIPath(PATH_SIGN_IN);
	}
	...
	public void verifyThatWeCanFindRussiaUsingTheCodeRU() {
		...
		stepsRestHttpMethods.checkHttpResponse(HTTP_CODE_400);
	}

	@Test
	@Title("Запрос без Cookie")
	public void requestWithoutCookie() {
		stepsRestHttpMethods.preparingRequestBody(CONTENT_TYPE,REQUEST_BODY);
		stepsRestHttpMethods.doPostRequest();
		stepsRestHttpMethods.checkHttpResponse(HTTP_CODE_403);
	}
}
